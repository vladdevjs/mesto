...
**Задача:** Разработать одностраничное приложение с функциями добавления карточек, редактированием профиля, возможностью поставить или убрать лайкю Должна быть реализована валидация форм.
